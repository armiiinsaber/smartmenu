...
/**
 * BULLETPROOF PRINT + CLEAN DOT-LEADER + SERVER-SIDE PDF
 * ▸ Header stays on page 1.
 * ▸ Dotted leader begins after dish name.
 * ▸ Print button hits /api/pdf/[slug] (no browser headers/footers).
 */
...
export default function MenuPage() {
  ...
  /* Download clean PDF generated by Edge Function */
